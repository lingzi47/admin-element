<template>
  <div class="user">
    ...
    >
      ...
      <el-table-column prop="days" label="赠送会员时长" align="center">
      </el-table-column>
...
<script>
import { goodsMemList, goodsMemEx, userStart, userBlm } from "@/request/api";
