...
export default {
  ...
  data() {
    return {
      ...
      Visible: false,
      time: "",
      url: "?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9__eyJpZCI6MzR9__wR97BhC5tc6sVq8WLeSyybOK75Xe7fjXJ1Yuasi-aSo&shop_type=5&order_no=&goods_name=&name=&phone=&label=&order_status=",
      form: {
        goods_name: "",
        order_no: "",
        time: "",
