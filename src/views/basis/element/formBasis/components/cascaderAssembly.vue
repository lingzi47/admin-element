...
<template>
  ...
  <div class="cascaderAssembly">
    <div class="explain">
      ...
      <p>二、自定义模板：可以通过scoped slot对级联选择器的备选项的节点内容进行自定义；</p>
      <p>三、el-cascader事件：change:选项改变时触发</p>
    </div>
    <el-form :inline="true" :model="form">
      <el-form-item>
        <el-cascader v-model="form.value1" :options="areaArr" :props="{value: 'code', label: 'name'}" placeholder="带搜索的级联" filterable @change="change"></el-cascader>
      </el-form-item>
      <el-form-item>
        <el-cascader v-model="form.value2" :options="areaArr" :props="{value: 'code', label: 'name'}" placeholder="自定义节点">
