  ...
  <div class="AddDialog">
    ...
    >
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="爆款价格" prop="hot_price">
            <el-input
              v-model="goodsForm.hot_price"
              placeholder="请输入爆款价格"
            ></el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="首单邮费" prop="one_postage">
            <el-input
              v-model="goodsForm.one_postage"
              placeholder="请输入首单邮费"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="次单邮费" prop="two_postage">
            <el-input
              v-model="goodsForm.two_postage"
              placeholder="请输入次单邮费"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="限购库存" prop="all_num">
            <el-input
              v-model="goodsForm.all_num"
              placeholder="请输入限购库存"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="4">
          <el-form-item class="xian">
            <el-checkbox v-model="checke" @change="all">不限购</el-checkbox>
          </el-form-item></el-col
        >
        <el-col :span="8">
          <el-form-item label="个人限购" prop="one_num">
            <el-input
              v-model="goodsForm.one_num"
              placeholder="请输入个人限购"
            ></el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="4">
          <el-form-item class="xian">
            <el-checkbox v-model="checked" @change="one">不限购</el-checkbox>
          </el-form-item></el-col
        >
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        all_num: [
          { required: true, message: "请输入全部限购", trigger: "blur" },
        ],
        one_num: [
          { required: true, message: "请输入个人限购", trigger: "blur" },
        ],
        new_price: [
          { required: true, message: "请输入现价格", trigger: "blur" },
        ],
        hot_price: [
          { required: true, message: "请输入爆款价格", trigger: "blur" },
        ],
        one_postage: [
          { required: true, message: "请输入首单邮费", trigger: "blur" },
        ],
        two_postage: [
          { required: true, message: "请输入次单邮费", trigger: "blur" },
        ],
  ...
  methods: {
    all() {
      this.goodsForm.all_num = 0;
    },
    one() {
      this.goodsForm.one_num = 0;
    },
    handleChange(val) {
      //console.log(val);
    ...
    show(type, row) {
      ...
      if (type == 1) {
        ...
        if (this.goodsForm.all_num == 0) {
          this.checke = true;
        }
        if (this.goodsForm.one_num == 0) {
          this.checked = true;
        }

        //console.log(this.fileList);
        //console.log(this.goodsForm.banners);
      }
    },
        ...
        if (valid) {
          if (this.type == 1) {
            let res = await shopGoodsadd({
              ...
              all_num: this.goodsForm.all_num,
              one_num: this.goodsForm.one_num,
              old_price: this.goodsForm.old_price,
              new_price: this.goodsForm.new_price,
              hot_price: this.goodsForm.hot_price,
              type_id: this.goodsForm.type_id,
              two_postage: this.goodsForm.two_postage,
              one_postage: this.goodsForm.one_postage,
