<template>
  <div class="wangeditor">
    <basis-layout title="富文本编辑器" style="margin-top: 10px">
      <div class="explain">
        详细配置见官网：<a href="https://www.wangeditor.com/" target="_blank"
          >https://www.wangeditor.com/</a
        >
      </div>
      <div
...
export default {
  ...
  mounted() {
    ...
    this.phoneEditor.config.menuTooltipPosition = "down";
